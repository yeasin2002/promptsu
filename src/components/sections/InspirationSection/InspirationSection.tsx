            ...
            <div className="flex flex-col w-full max-w-[878px] items-center gap-8 lg:gap-12 absolute top-[60px] lg:top-[139px] left-1/2 -translate-x-1/2">
              <div className="flex flex-col items-center gap-5 lg:gap-7 relative self-stretch w-full">
                <div className="inline-flex flex-col items-center gap-2 relative">
                  ...
                  <h1 className="relative w-full max-w-[674.68px] font-manrope  font-medium text-white text-3xl sm:text-4xl lg:text-[64px] text-center tracking-[-0.64px] leading-tight lg:leading-[74px] px-4 lg:px-0">
                    Find Inspiration.
                    <br />
                ...
                <p className="relative w-full max-w-[735.65px] font-manrope  font-normal text-[#ffffff99] text-sm lg:text-base text-center tracking-[-0.29px] leading-6 lg:leading-7 px-4 lg:px-0">
