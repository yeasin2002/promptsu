...
import { MinusSignIcon, PlusSignIcon, ArrowLeft01Icon, ArrowDown01Icon, MailValidation01Icon, ArchiveIcon, ClockIcon, CalendarAdd01Icon, AddToListIcon, TagIcon, Delete02Icon, ArrowRight01Icon, VolumeOffIcon, Tick02Icon, UserRemove01Icon, Share03Icon, Copy01Icon, AlertCircleIcon, BotIcon, Search01Icon, StarIcon, AudioWave01Icon, ArrowUp01Icon, BluetoothIcon, MoreVerticalCircle01Icon, FileIcon, FolderIcon, FolderOpenIcon, CodeIcon, MoreHorizontalCircle01Icon, SearchIcon, FloppyDiskIcon, DownloadIcon, EyeIcon, LayoutIcon, PaintBoardIcon, SunIcon, MoonIcon, ComputerIcon, HelpCircleIcon, File01Icon, LogoutIcon, ShoppingBasket01Icon } from "@hugeicons/core-free-icons"
      ...
      <div className="flex flex-col gap-6">
        <ButtonGroup>
          ...
          <ButtonGroup>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger render={<Button variant="outline" size="icon-sm" aria-label="More Options"><HugeiconsIcon icon={ArrowDown01Icon} strokeWidth={2} /></Button>} />
              <DropdownMenuContent align="end" className="w-48">
                ...
                <DropdownMenuGroup>
                  ...
                  <DropdownMenuItem>
                    <HugeiconsIcon icon={AddToListIcon} strokeWidth={2} />
                    Add to List
                  </DropdownMenuItem>
                  <DropdownMenuSub>
                    <DropdownMenuSubTrigger>
        ...
        <div className="flex gap-4">
          ...
          <ButtonGroup>
            <ButtonGroup>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger render={<Button variant="outline" size="icon"><HugeiconsIcon icon={ArrowDown01Icon} strokeWidth={2} /></Button>} />
            ...
            <ButtonGroup>
              ...
              <Popover>
                <PopoverTrigger render={<Button variant="outline" size="icon" aria-label="Open Popover"><HugeiconsIcon icon={ArrowDown01Icon} strokeWidth={2} /></Button>} />
      ...
      <div className="flex flex-col gap-6">
        ...
        <InputGroup>
          ...
          <InputGroupAddon align="inline-end">
            <Tooltip>
              <TooltipTrigger render={<InputGroupButton className="rounded-full" size="icon-xs" aria-label="Info"><HugeiconsIcon icon={AlertCircleIcon} strokeWidth={2} /></InputGroupButton>} />
        ...
        <Field>
          ...
          <InputGroup>
            ...
            <InputGroupAddon>
              <Popover>
                <PopoverTrigger render={<InputGroupButton variant="secondary" size="icon-xs" aria-label="Info"><HugeiconsIcon icon={AlertCircleIcon} strokeWidth={2} /></InputGroupButton>} />
                <PopoverContent
                  align="start"
                  alignOffset={10}
            ...
            <InputGroupAddon align="inline-end">
              <InputGroupButton
                ...
                aria-label="Favorite"
              >
                <HugeiconsIcon icon={StarIcon} strokeWidth={2} data-favorite={isFavorite} className="data-[favorite=true]:fill-primary data-[favorite=true]:stroke-primary" />
              </InputGroupButton>
            </InputGroupAddon>
          </InputGroup>
        </Field>
        <ButtonGroup className="w-full">
          ...
          <ButtonGroup className="flex-1">
            <InputGroup>
              ...
              <InputGroupAddon align="inline-end">
                <Tooltip>
                  <TooltipTrigger render={<InputGroupButton onClick={() => setVoiceEnabled(!voiceEnabled)} data-active={voiceEnabled} className="data-[active=true]:bg-primary data-[active=true]:text-primary-foreground" aria-pressed={voiceEnabled} size="icon-xs" aria-label="Voice Mode"><HugeiconsIcon icon={AudioWave01Icon} strokeWidth={2} /></InputGroupButton>} />
      ...
      <Empty className="h-full flex-none border">
        ...
        <EmptyContent>
          <div className="flex gap-2">
            ...
            <AlertDialog>
              <AlertDialogTrigger render={<Button>Connect Mouse</Button>} />
    ...
    <Example title="Form">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardAction>
            <DropdownMenu>
              <DropdownMenuTrigger render={<Button variant="ghost" size="icon"><HugeiconsIcon icon={MoreVerticalCircle01Icon} strokeWidth={2} /><span className="sr-only">More options</span></Button>} />
              <DropdownMenuContent
                align="end"
