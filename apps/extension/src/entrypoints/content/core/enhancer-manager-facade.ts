 ...
 */
export function createEnhancerManager() {
...
/**
 * Type definition for the enhancer manager facade
 */
export type EnhancerManagerFacade = ReturnType<typeof createEnhancerManager>;
