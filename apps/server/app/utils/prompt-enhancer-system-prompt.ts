type PromptEnhancerSystemPromptType = {
  role: 'system' | 'user' | 'assistant';
  content: string;
};

// export const PromptEnhancerSystemPrompt: PromptEnhancerSystemPromptType[] =

export const PromptEnhancerSystemPrompt = (input: string): PromptEnhancerSystemPromptType[] => {
  return [
    {
      role: 'system',
      content: `
