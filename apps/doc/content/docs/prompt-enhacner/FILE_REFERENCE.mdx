...
description: This document provides detailed information about each file in the content script core directory.
---
...
function MyComponent() {
  const { initialize, destroy, isReady, platform, isInitialized } =
    useEnhancerManager();
